...
public class Menssage extends JDialog {

    private double distance;
    public Menssage(Frame parent, boolean modal,double distance) {
        super(parent, modal);
        initComponents();
        this.setTitle("MENSAJE");
        SubstanceLookAndFeel.setDecorationType(this.jButton1, DecorationAreaType.HEADER);
        this.distance = distance;
        this.jLabel1.setText(""+fijarNumero(redondearDecimales(distance,3),3)+" Km");
    }
